    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <p class="mb-4">가입된 회원 정보들을 조회 및 관리할 수 있는 페이지입니다. 이 곳에 있는 기능을 통해 관리를 진행해주세요. </p>
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <c:forEach items="${memberInfo}" var = "info">
                                    <tr id="trHover">
                                        ...
                                        <td>${info.regDate}</td>
                                        <td>${info.grade}</td>
                                        <td style="text-align: center;"><a onclick="test('/admin/memberDelete?m_no=${info.m_no}')" href="#">삭제</a></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
