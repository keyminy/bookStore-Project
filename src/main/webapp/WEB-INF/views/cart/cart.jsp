										...
										<table
											...
											<thead>
												<tr>
													...
													<th class="product-remove">All<input type="checkbox" name="selectAll"
													...
													<tr class="woocommerce-cart-form__cart-item cart_item">
														...
														<td class="product-price" data-title="Price"><span
															...
															style="width: max-content;"><fmt:formatNumber
																	value="${cart.price}" pattern="###,###"></fmt:formatNumber>원</span>
														</td>
														...
														<td class="product-subtotal" data-title="Total"><span
															class="woocommerce-Price-amount amount"
															style="width: max-content;"><fmt:formatNumber
																	value="${cart.cart_total_price}" pattern="###,###"></fmt:formatNumber>원</span>
														</td>
														<td class="product-remove">
														<c:choose>
														<c:when test="${cart.stock !=0 }">
															<input type="checkbox" name="cartItem"
