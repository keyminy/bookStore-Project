					...
					<sec:authorize access="isAuthenticated()">
						<li class="nav-item"><span class="link-black-100">안녕하세요!
								...
								<sec:authorize access="hasRole('ROLE_ADMIN')">
									<a href="/admin/main" style="margin-left:30px;">관리자 페이지로 가기</a>
								</sec:authorize>
					</sec:authorize>
				</ul>
			</div>
		...
		<div class="bg-white">
			<div class="container py-3 py-md-4">
              ...
              <div class="login_success_area">
                  <span>회원 : ${principal.member.name}</span>
                  <span>충전캐쉬 :  <fmt:formatNumber value="${principal.member.cash}" type="currency"/></span>
					...
					<div
						...
						<a href="mailto:info@bookworm.com" class="mr-4 mb-4 mb-md-0">
							<div
								...
								<div class="ml-2">
									<span class="text-secondary-gray-1090 font-size-1">info@book.co.kr</span>
						...
						<a href="tel:+1246-345-0695">
							<div
								...
								<div class="ml-2">
									<span class="text-secondary-gray-1090 font-size-1">010-1234-1234</span>
