								...
								<form name="checkout" method="post"
											...
											<div class="woocommerce-billing-fields">
												<div class="d-flex">
													...
													<div class="checkout-header">
														주문자 정보와 동일 <input type="checkbox" id="checkout-checkbox" onChange="checkBoxOnChange(`${principal.member.name}`,`${principal.member.phone}`,`${principal.member.email}`,`${principal.member.roadAddress}`,`${principal.member.zipcode}`,`${principal.member.otherAddress}` );">
													</div>
												</div>
													...
													<div class="form-group mb-4">
														<div class="js-form-message js-focus-state">
															...
															<input path="email1" type="text"
																...
																id="emailDomain" placeholder="도메인을 선택해주세요."
									...
									<div id="order_review"
										...
										<div id="checkoutAccordion"
											...
											<div class="p-4d875 border">
												<h3 class="checkout-title mb-0 font-weight-medium font-size-3">Pay Information</h3>
													<c:choose>
														<c:when test="${principal.member.cash - sub_total_price < 0}">
															<span style="color : tomato;">잔액이 부족하여 결제할 수 없습니다!!</span>
														</c:when>
														<c:otherwise>
															<table class="shop_table shop_table_responsive">
																<tbody>
																	<tr>
																			...
																			<td><span
																				class="woocommerce-Price-amount amount d-flex">
																				<fmt:formatNumber value="${principal.member.cash}"
																						pattern="###,###"></fmt:formatNumber>원
																				</span></td>
																	</tr>
																	<tr>
																			...
																			<td><span
																				class="woocommerce-Price-amount amount d-flex">
																				<fmt:formatNumber value="${principal.member.cash-sub_total_price}"
																						pattern="###,###"></fmt:formatNumber>원
																				</span></td>
																	</tr>
																</tbody>
...
<%-- 												<c:choose>
											...
											<input type="hidden" name="order_price"
												...
												data-value="Place order" data-status="checkout"> <input type="hidden"
