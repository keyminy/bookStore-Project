	...
	<main id="content">
		<div class="mb-5 space-bottom-lg-3">
			<div class="py-3 py-lg-7">
				<h6 class="font-weight-medium font-size-7 text-center my-1">About
					Us</h6>
			</div>
			<img class="img-fluid" src="https://placehold.it/1920x650"
			...
			<div class="container">
					...
					<div class="col-lg-9 mx-auto">
						<div
							...
							<div class="mb-4 mb-lg-7 ml-xl-4">
								<h6 class="font-weight medium font-size-10 mb-4 mb-lg-7">Welcome
									to Bookworm</h6>
								<p class="font-weight-medium font-italic">“ Many desktop
									publishing packages and web page editors now use Lorem Ipsum as
									their default model search for eolved over sometimes by
									accident, sometimes on purpose ”</p>
							</div>
							<div class="mb-4 pb-xl-1 ml-xl-4">
								<h6 class="font-weight-medium font-size-4 mb-4">What we
									really do?</h6>
								<p class="font-size-2">Mauris tempus erat laoreet turpis
									...
									tincidunt urna. Integer tincidunt nec nisl vitae ullamcorper.
									Proin sed ultrices erat. Praesent varius ultrices massa at
									faucibus. Aenean dignissim, orci sed faucibus pharetra, dui mi
									dignissim tortor, sit amet condimentum mi ligula sit amet
									augue. Pellentesque vitae eros eget enim mollis placerat.</p>
							</div>
							<div class="ml-xl-4">
								<div class="row">
									<div class="col-md-6">
										<h6 class="font-weight-medium font-size-4">Our Vision</h6>
										<p class="font-size-2">Pellentesque sodales augue eget
											ultricies ultricies. Cum sociis natoque penatibus et magnis
											dis parturient montes, nascetur ridiculus mus. Curabitur
											sagittis ultrices condimentum.</p>
									</div>
									<div class="col-md-6">
										<h6 class="font-weight-medium font-size-4">Our Vision</h6>
										<p class="font-size-2">Lorem ipsum dolor sit amet,
											consectetur adipiscing elit. Etiam quis diam erat. Duis velit
											lectus, posuere a blandit metus mauris, tristique quis sapien
											eu, rutrum vulputate enim.</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="mb-5 mb-lg-7">
					<div
						class="d-md-flex align-items-center justify-content-between px-xl-10">
				...
				<div class="mb-5 mb-lg-10">
					...
					<ul class="list-unstyled my-0 list-features row d-md-flex">
						<li class="list-feature mb-5 mb-lg-0 col-md-6 col-lg-3">
							<div
								class="media flex-column align-items-center align-items-md-start pr-xl-3">
								<div
									class="feature__icon font-size-14 text-primary text-lh-xs mb-3">
									<i class="glyph-icon flaticon-delivery"></i>
								</div>
								<div class="media-body text-center text-md-left">
									<h4 class="feature__title font-size-3 text-dark">Free
										Delivery</h4>
									<p class="feature__subtitle m-0 text-dark">Duis aute irure
						...
						<li class="list-feature  mb-5 mb-lg-0 col-md-6 col-lg-3">
							<div
								...
								<div class="media-body text-center text-md-left">
									<h4 class="feature__title font-size-3 text-dark">Secure
										Payment</h4>
									<p class="feature__subtitle m-0 text-dark">Duis aute irure
										dolor in reprehenderit in voluptate velit esse cillum dolore
										eu.</p>
						...
						<li class="list-feature  mb-5 mb-md-0 col-md-6 col-lg-3">
							<div
								...
								<div class="media-body text-center text-md-left">
									<h4 class="feature__title font-size-3 text-dark">Money
										Back Guarantee</h4>
									<p class="feature__subtitle m-0 text-dark">Duis aute irure
										dolor in reprehenderit in voluptate velit esse cillum dolore
										eu.</p>
						...
						<li class="list-feature  mb-5 mb-md-0 col-md-6 col-lg-3">
							<div
								...
								<div class="media-body text-center text-md-left">
									<h4 class="feature__title font-size-3 text-dark">24/7
										Support</h4>
									<p class="feature__subtitle m-0 text-dark">Duis aute irure
										dolor in reprehenderit in voluptate velit esse cillum dolore
										eu.</p>
					...
					<div class="js-slick-carousel u-slick"
						...
						<div class="product__inner overflow-hidden">
							<div
								...
								<div
									class="woocommerce-loop-product__thumbnail border pt-5 mb-3">
									<a href="#" class="d-block"><img
										src="https://placehold.it/180x320"
										class="img-fluid mx-auto d-block attachment-shop_catalog size-shop_catalog wp-post-image"
										alt="image-description"></a>
								</div>

								<div class="woocommerce-loop-product__body product__body">
									<h6 class="font-weight-regular mb-1">Anna Baranov</h6>
									<span class="font-size-2 text-secondary-gray-700">Client
										Care</span>
								</div>
							</div>
						</div>
						<div class="product__inner overflow-hidden">
							<div
								class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
								<div
									class="woocommerce-loop-product__thumbnail border border-left-0 pt-5 mb-3">
									<a href="#" class="d-block"><img
										src="https://placehold.it/180x320"
										class="img-fluid mx-auto d-block attachment-shop_catalog size-shop_catalog wp-post-image"
										alt="image-description"></a>
						...
						<div class="product__inner overflow-hidden">
							<div
								...
								<div class="woocommerce-loop-product__body product__body">
									...
									<span class="font-size-2 text-secondary-gray-700">Support
										Boss</span>
								</div>
							</div>
						</div>
						<div class="product__inner overflow-hidden">
							<div
								...
								<div class="woocommerce-loop-product__body product__body">
									...
									<span class="font-size-2 text-secondary-gray-700">Delivery
										Driver</span>
								</div>
							</div>
						</div>
						<div class="product__inner overflow-hidden">
							<div
								...
								<div class="woocommerce-loop-product__body product__body">
									...
									<span class="font-size-2 text-secondary-gray-700">Packaging
										Girl</span>
								</div>
							</div>
						</div>
				...
				<div>
					<h6 class="font-weight-medium font-size-7 mb-4 mb-lg-9">Company
						Partners</h6>
					<div class="d-lg-flex align-items-center justify-content-between">
						<div class="text-center mb-5 mb-lg-0">
							<img class="img-fluid" src="../../assets/img/150x32/img1.png"
								alt="Image-Description">
						</div>
						<div class="text-center mb-5 mb-lg-0">
							<img class="img-fluid" src="../../assets/img/150x32/img2.png"
								alt="Image-Description">
						</div>
						<div class="text-center mb-5 mb-lg-0">
							<img class="img-fluid" src="../../assets/img/150x32/img3.png"
								alt="Image-Description">
						</div>
						<div class="text-center mb-5 mb-lg-0">
							<img class="img-fluid" src="../../assets/img/150x32/img4.png"
								alt="Image-Description">
						</div>
						<div class="text-center mb-5 mb-lg-0">
							<img class="img-fluid" src="../../assets/img/150x32/img6.png"
								alt="Image-Description">
						</div>
						<div class="text-center mb-5 mb-lg-0">
							<img class="img-fluid" src="../../assets/img/150x32/img5.png"
								alt="Image-Description">
						</div>
					</div>
				</div>
